...
#stright_line
start_pts = [(240, 0), (620, 0)]
end_pts = [(0, 310), (639, 639)]
...
start_points = [(0, 190), (639, 270)]  # List of start points
end_points = [(639, 10), (0, 40)]  # List of end pointsx上點 x 小向左y 小向上
...
kp_heading = 3  # Default proportional gain for heading
kd_heading = 8  # Default derivative gain for heading
kp_X = 0.3 # Default proportional gain for heading
    ...
    while True:
        ...
        if turn_side == 8:
            ...
            if  roi_values[0]> roi_values[1] and start_0:
                ...
                start_1 = True
                start_0 = False
            if  abs(heading) < 70 and start_1 or abs(heading) > 90 and start_1:
                if ROI_1:
            ...
            if start_2:
                PWM = 40
                combined_control_signal = 0
            if start_2 and roi_values[2] >= 6200:
                start_2 = False
                start_3 = True
        ...
        if turn_side == 0 or turn_side == 2 or turn_side == 6:
            ...
            elif roi_values[0] >= roi_values0 and heading < target_heading[count] + 15 and heading > target_heading[count] - 15 and roi_values[1] < roi_values[0] and abs(target_heading[count]) != 180 or abs(target_heading[count]) == 180 and roi_values[0] >= roi_values0 and heading < -165 and heading > 165 and roi_values[1] < roi_values[0] :
                print("right")
